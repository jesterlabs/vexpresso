...
class Metadata:
    def __init__(
        self, metadata: pd.DataFrame, con: Optional[DuckDBPyConnection] = None
    ):
    ...
    def filter(
        self, condition: str, return_metadata: bool = True
    ) -> Union[Metadata, pd.DataFrame]:
    ...
    def add(
        self, metadata: Union[Dict[str, Any], Iterable[Dict[str, Any]], pd.DataFrame]
    ):
